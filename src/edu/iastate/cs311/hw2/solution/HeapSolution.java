 package edu.iastate.cs311.hw2.solution;
/**
 * @author 
...
public class HeapSolution<E extends Comparable<? super E>>
   implements ExtendedPriorityQueue<E>
{
  ...
  public HeapSolution(List<E>  aList)
  {
     int j, k;
     int len = aList.size();
     if ( len < 1 )
  ...
  public static <E extends Comparable<? super E>> void heapSort(List<E> aList)
  {
    ...
    HeapSolution<E> aHeap = new HeapSolution<E>(aList);
    aList.clear();
    while ( ! aHeap.isEmpty() )
